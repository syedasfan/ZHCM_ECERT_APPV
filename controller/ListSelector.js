sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("zhcm.ecert.appv.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ZECER_HCM_TEST.ZECER_HCM_TEST_NEW.controller.ListSelector
			 */
			 ...
			 * @return {ZECER_HCM_TEST.ZECER_HCM_TEST_NEW.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
